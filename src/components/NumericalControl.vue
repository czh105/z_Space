  ...
  setup(props, { emit }) {
    ...
    watch(topicNum, () => {
      ...
      if (topicNum.value === 1) {
        ...
        startFree(
          [0, 0, 0, 0, 0, 0],
          { x: -9.06, y: 20.38, z: -11.74 },
          { x: -24.94, y: 10.2, z: -0.45 }
        );
      }
      ...
      if (topicNum.value === 2) {
        ...
        startFree(
          getRobotPosition(),
          { x: -14.6, y: 15.13, z: -3.38 },
          { x: -19.91, y: 10.41, z: -1.02 }
        );
      }
      ...
      if (topicNum.value === 3) {
        ...
        startFree(
          ...
          { x: -7.16, y: 21.6, z: -12.44 },
          { x: -18.7, y: 10.19, z: 0.02 }
        );
      }
  ...
  <div class="controls_box">
    ...
    <div class="touchpage" v-if="topicNum === 14">
      <div class="screen" style="left: 63px; top: 67px">
        ...
        <div
          class="run"
          style="left: 210px; top: 134px"
          @click="switchAll('数控开关')"
        >
          开始
        </div>
      </div>
    ...
    <div class="left_box" v-if="showlr">
      ...
      >
        ...
        <div
          class="t1-1 conBtn"
          v-if="topicNum === 4"
          @click="setLeftContent('数控单元调试实训任务'), topicNext(true)"
        >
          下一步
        </div>
        <div
      ...
      >
        ...
        <div class="codepage" v-if="topicNum === 9">
          ...
          <div
            class="conBtn"
            style="width: 57px; height: 14px; left: 110px; top: 143px"
          >
            <thinking-select
              :list="[
                { label: 'TOpClamp', value: 0 },
