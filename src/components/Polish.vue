  ...
  setup(props, { emit }) {
    ...
    const topicOneImg = computed(() => {
      ...
      switch (topicNum.value) {
        ...
        case 9:
          ...
          break;
        case 10:
          return `background-image: url( "./polish/a7.png"  )`;
          break;
        case 10.5:
        ...
        case 11:
          ...
          break;
        case 12:
          return `background-image: url( "./polish/a9.png"  )`;
          break;
        case 12.5:
          return `background-image: url( "./polish/pp.png"  )`;
          break;
        ...
        case 17:
          ...
          break;
        case 18:
          return `background-image: url( "./polish/b5.png"  )`;
          break;
        case 18.5:
          return `background-image: url( "./polish/pp.png"  )`;
          break;
    ...
    watch(topicNum, () => {
      ...
      if (topicNum.value === 1) {
        ...
        startFree(
          [0, 0, 0, 0, 0, 0],
          { x: -4.22, y: 15.68, z: 1.81 },
          { x: -7.38, y: 9.07, z: -4.49 }
        );
      }
      if (topicNum.value === 2) {
        showHelp.value = true;
      ...
      if (topicNum.value === 3) {
        ...
        startFree(
          [0, 0, 0, 0, 0, 0],
          { x: 0.23, y: 20.37, z: -9.84 },
          { x: -9.31, y: 11.86, z: -4.57 }
        );
      }
      if (topicNum.value === 5) {
        j62.visible = true;
...
<template>
  <div class="controls_box">
    ...
    <div class="helppage" v-if="showHelp">
      <img
        style="width: 490px; height: 340px"
        v-if="topicNum === 2"
        src="/polish/a1.png"
      />
      <img
    ...
    <div class="touchpage" v-if="topicNum === 1">
      <div class="screen" style="left: 80px; top: 78px">
        ...
        <div
          class="ld"
          style="left: 320px; top: 10px; background-color: rgb(247, 75, 75)"
        ...
        <div
          class="ld"
          style="left: 370px; top: 10px; background-color: rgb(75, 247, 104)"
        ...
        <div
          class="ld"
          style="left: 320px; top: 50px; background-color: rgb(247, 75, 75)"
        ...
        <div
          class="ld"
          style="left: 370px; top: 50px; background-color: rgb(75, 247, 104)"
        ...
        <div
          class="ld"
          style="left: 320px; top: 100px; background-color: rgb(247, 75, 75)"
        ...
        <div
          class="ld"
          style="left: 370px; top: 100px; background-color: rgb(75, 247, 104)"
        ...
        <div
          class="ld"
          style="left: 320px; top: 150px; background-color: rgb(247, 75, 75)"
        ...
        <div
          class="ld"
          style="left: 370px; top: 150px; background-color: rgb(75, 247, 104)"
        ...
        <div
          class="ld"
          style="left: 320px; top: 185px; background-color: rgb(247, 75, 75)"
        ...
        <div
          class="ld"
          style="left: 370px; top: 185px; background-color: rgb(75, 247, 104)"
        ...
        <div
          class="ld"
          style="left: 320px; top: 218px; background-color: rgb(247, 75, 75)"
        ...
        <div
          class="ld"
          style="left: 370px; top: 218px; background-color: rgb(75, 247, 104)"
    ...
    <div class="left_box" v-if="showlr">
      ...
      >
        ...
        <div
          class="t1-1 conBtn"
          v-if="topicNum === 3"
          @click="setLeftContent('打磨单元调试实训任务'), topicNext(true)"
        >
          下一步
        </div>
        <div
      ...
      >
        ...
        <div class="codepage" v-if="topicNum === 7">
          <div
            class="conBtn"
            style="width: 41px; height: 14px; left: 59px; top: 176px"
          >
            <thinking-select
              :list="[
                { label: 'Set', value: 0 },
          ...
          <div
            class="conBtn"
            style="width: 127px; height: 14px; left: 103px; top: 176px"
          >
            <thinking-select
              :list="[
          ...
          <div
            class="conBtn"
            style="width: 41px; height: 14px; left: 59px; top: 211px"
          >
            <thinking-select
              :list="[
                { label: 'Set', value: 1 },
          ...
          <div
            class="conBtn"
            style="width: 127px; height: 14px; left: 103px; top: 211px"
          >
            <thinking-select
              :list="[
                { label: 'TOpTabletight1', value: 1 },
        ...
        <div class="codepage" v-if="topicNum === 8">
          <div
            class="conBtn"
            style="width: 44px; height: 14px; left: 57px; top: 160px"
          >
            <thinking-select
              :list="[
                { label: 'Set', value: 1 },
          ...
          <div
            class="conBtn"
            style="width: 127px; height: 14px; left: 107px; top: 160px"
          >
            <thinking-select
              :list="[
                { label: 'TOpTabletight1', value: 1 },
        ...
        <div
          class="conBtn"
          style="width: 94px; height: 25px; left: 193px; top: 286px"
          v-if="topicNum === 15"
          @click="topicNum++"
        ></div>
