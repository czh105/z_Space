  ...
  setup(props, { emit }) {
    ...
    function upDown(type: string) {
      ...
      if (nowType.value === "A") {
        ...
        console.log("actionsNum", actionsNum);
        switch (type) {
          case "left":
            actionsNum--;
            if (actionsNum < 0) {
...
<template>
  <div>
    <div class="controls_box" v-if="!showSub">
      ...
      <div class="left_box" v-if="topicNum >= 0 && topicNum !== 6">
        ...
        >
          ...
          <div
            class="conBtn"
            style="width: 58px; height: 30px; left: 7px; top: 3px; z-index: 9"
            v-if="topicNum === 39"
            @click="topicNum++"
          ></div>
          <div
    ...
    z-index: 9;
            "
            v-if="topicNum === 34.4"
           @click="(topicNum = 34.5),switchZhou('C')"
          ></div>
      ...
      <div class="right_box" v-if="topicNum >= 0 && topicNum !== 6">
        <div v-if="topicNum <34 ||topicNum>34.9">
          ...
          <div class="right_st" >
            ...
            <div
              class="close hongkuang"
              v-if="topicNum === 3 || topicNum === 4"
              @click="topicNum++"
            ></div>
            <!-- <div
              class="dianjideng"
        ...
        <div class="pBtn" v-if="topicNum === 32.5" @click="topicNum = 33">下一步</div>
        <div
          class="pBtn"
          v-if="topicNum > 20 && topicNum < 31"
          @click="newNextTopic"
        >
          下一步
        </div>
        <div
          class="pBtn"
          v-if="topicNum > 34.4 && topicNum < 34.9"
          @click="topicNum = 35"
        >
          下一步
        </div>
    ...
    <div
      ...
      v-if="topicNum >= 0 && topicNum != 6 && (topicNum < 30 || topicNum > 34.9)&& topicNum<39"
    >
    ...
    <div
      class="shuoming_box"
      :style="switchOtherImg"
      v-if="topicNum > 44 && topicNum < 52"
    ></div>
  </div>
</template>
