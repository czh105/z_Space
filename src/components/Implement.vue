    ...
    watch(topicNum, () => {
     ...
     sp7.visible = false
      ...
      if (topicNum.value === 1) {
        ...
        startFree(
          [0, 0, 0, 0, 0, 0],
          { x: -4.28, y: 22.36, z: -14.54 },
          { x: -13.91, y: 7.74, z: 2.39 }
        );
      }
      if (topicNum.value === 2) {
        showHelp.value = true;
    ...
    <div class="left_box" v-if="showlr">
      ...
      >
        ...
        <div
          class="t1-1 conBtn"
          v-if="topicNum === 3"
          @click="setLeftContent('执行单元调试'), topicNext(true)"
        >
          下一步
        </div>
        <div
      ...
      >
        ...
        <div class="codepage" v-if="topicNum === 7">
          <div
            class="conBtn"
            style="width: 33px; height: 14px; left: 56px; top: 108px"
          >
            <thinking-select
              :list="[
                { label: 'Set', value: 1 },
          ...
          <div
            class="conBtn"
            style="width: 47px; height: 14px; left: 57px; top: 211px"
          >
            <thinking-select
              :list="[
                { label: 'MoveJ', value: 0 },
        ...
        <div class="codepage" v-if="topicNum === 8">
          <div
            class="conBtn"
            style="width: 48px; height: 14px; left: 57px; top: 124px"
          >
            <thinking-select
              :list="[
                { label: 'MoveJ', value: 0 },
        ...
        <div
          class="conBtn"
          style="width: 96px; height: 32px; left: 196px; top: 292px"
          v-if="topicNum === 9"
          @click="topicNum = 9.1"
        ></div>
        <div
        ...
        <div
          class="conBtn"
          style="width: 96px; height: 31px; left: 290px; top: 292px"
          v-if="topicNum === 9.2"
          @click="topicNum = 9.3"
        ></div>
        <div
        ...
        <div class="codepage" v-if="topicNum === 19">
          <div
            class="conBtn"
            style="width: 48px; height: 14px; left: 90px; top: 124px"
          >
            <thinking-select
              :list="[
                { label: 'MoveJ', value: 0 },
          ...
          <div
            class="conBtn"
            style="width: 33px; height: 14px; left: 90px; top: 143px"
          >
            <thinking-select
              :list="[
                { label: 'Set', value: 1 },
