  ...
  setup(props, { emit }) {
    ...
    watch(topicNum, () => {
      ...
      if (topicNum.value === 1) {
        ...
        scaralun.visible = true;
        startFree(
          { x: 2.25, y: 20.62, z: -11.23 },
          { x: 0.17, y: 6.63, z: 4.12 }
        );
      }
      if (topicNum.value === 6) {
        showlr.value = false;
        ...
        animateState(arr[0], 1000, () => {
          animateState(arr[1], 1000, () => {
            ...
            animateState(arr[0], 1000, () => {
              startFree(
                { x: 6.12, y: 19.08, z: -15.08 },
                { x: -2.36, y: 0.09, z: 3.04 }
              );
        ...
        animateState(arr[0], 1000, () => {
          animateState(arr[1], 1000, () => {
            ...
            animateState(arr[0], 1000, () => {
              ...
              animateState([112.87, -29, 288, 4.75], 1000, () => {});
              scaralun.position.set(-821.31, -79.11, -357.87);
      ...
      if (topicNum.value === 21) {
        ...
        animateState(arr[0], 1000, () => {
          animateState(arr[1], 1000, () => {
            ...
            animateState(arr[0], 1000, () => {
              startFree(
                { x: 10.56, y: 21.38, z: -12.96 },
                { x: 1.89, y: 0.57, z: 6.07 }
              );
              yadetou.visible = false;
              scaratou.visible = true;
              showlr.value = true;
              ...
              animateState(arr[3], 1000, () => {
                animateState(arr[2], 1000, () => {
                  animateState(arr[1], 1000, () => {
                    animateState(arr[0], 1000, () => {
                    startFree(
                      { x: 6.55, y: 17.01, z: -13.36 },
                      { x: 10.4, y: 6.36, z: -4.18 }
                    );
                    // showlr.value = true
                  });
                  });
...
<template>
  <div class="controls_box">
    ...
    <div class="touchpage" v-if="topicNum === 26">
      ...
      <div
        class="pBtn"
        @click="topicNum++, (showHelp = false), (showlr = false)"
      >
        下一步
      </div>
    </div>
    ...
    <div class="left_box" v-if="showlr">
      ...
      <div class="robot_opt" :style="topicOneImg">
        ...
        <div
          class="conBtn"
          style="width: 71px; height: 21px; left: 319px; top: 287px"
          v-if="topicNum === 2"
          @click="topicNum++"
        ></div>
        ...
        <div class="codepage" v-if="topicNum === 4">
          <div
            class="codeItem"
            style="width: 25px; height: 14px; left: 159px; top: 131px"
          >
            <thinking-select
              :list="[
                { label: 'OFF', value: 1 },
          ...
          <div
            class="codeItem"
            style="width: 57px; height: 14px; left: 160px; top: 164px"
          >
            <thinking-select
              :list="[
          ...
          <div
            class="codeItem"
            style="width: 28px; height: 14px; left: 160px; top: 194px"
          >
            <thinking-select
              :list="[
                { label: 'OFF', value: 0 },
          ...
          <div
            class="codeItem"
            style="width: 65px; height: 14px; left: 161px; top: 243px"
          >
            <thinking-select
              :list="[
        ...
        <div class="codepage" v-if="topicNum === 9">
          <div
            class="codeItem"
            style="width: 25px; height: 14px; left: 159px; top: 154px"
          >
            <thinking-select
              :list="[
                { label: 'OFF', value: 1 },
          ...
          <div
            class="codeItem"
            style="width: 57px; height: 14px; left: 160px; top: 185px"
          >
            <thinking-select
              :list="[
                { label: 'SRt_Pos', value: 1 },
          ...
          <div
            class="codeItem"
            style="width: 65px; height: 14px; left: 161px; top: 203px"
          >
            <thinking-select
              :list="[
                { label: 'SRt_Pos', value: 0 },
        ...
        <div class="codepage" v-if="topicNum === 14">
          <div
            class="codeItem"
            style="width: 66px; height: 14px; left: 160px; top: 110px"
          >
            <thinking-select
              :list="[
                { label: 'SRt_Pos', value: 0 },
          ...
          <div
            class="codeItem"
            style="width: 28px; height: 14px; left: 160px; top: 154px"
          >
            <thinking-select
              :list="[
                { label: 'SRt_Pos', value: 1 },
          ...
          <div
            class="codeItem"
            style="width: 55px; height: 14px; left: 161px; top: 185px"
          >
            <thinking-select
              :list="[
                { label: 'OFF', value: 1 },
        ...
        <div class="codepage" v-if="topicNum === 19">
          <div
            class="codeItem"
            style="width: 25px; height: 14px; left: 159px; top: 125px"
          >
            <thinking-select
              :list="[
                { label: 'SRt_Pos', value: 0 },
          ...
          <div
            class="codeItem"
            style="width: 57px; height: 14px; left: 160px; top: 155px"
          >
            <thinking-select
              :list="[
                { label: 'OFF', value: 0 },
          ...
          <div
            class="codeItem"
            style="width: 28px; height: 14px; left: 160px; top: 185px"
          >
            <thinking-select
              :list="[
                { label: 'SRt_Pos', value: 1 },
          ...
          <div
            class="codeItem"
            style="width: 65px; height: 14px; left: 161px; top: 231px"
          >
            <thinking-select
              :list="[
                { label: 'OFF', value: 1 },
        ...
        <div class="codepage" v-if="topicNum === 24">
          <div
            class="codeItem"
            style="width: 25px; height: 14px; left: 159px; top: 156px"
          >
            <thinking-select
              :list="[
                { label: 'OFF', value: 0 },
          ...
          <div
            class="codeItem"
            style="width: 67px; height: 14px; left: 160px; top: 216px"
          >
            <thinking-select
              :list="[
                { label: 'SRt_Pos', value: 1 },
          ...
          <div
            class="codeItem"
            style="width: 28px; height: 14px; left: 160px; top: 187px"
          >
            <thinking-select
              :list="[
                { label: 'OFF', value: 1 },
