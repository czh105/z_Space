    ...
    setup(props, { emit }) {
        ...
        const topicOneImg = computed(() => {
            ...
            switch (topicNum.value) {
                case 2:
                    return `background-image: url( "./hmia/a1.png"  )`;
                    break;
                case 3:
                    return `background-image: url( "./hmia/a2.png"  )`;
                    break;
                case 4:
                    return `background-image: url( "./hmia/a3.png"  )`;
                    break;
                case 5:
                    return `background-image: url( "./hmia/a4.png"  )`;
                    break;
                case 6:
                    return `background-image: url( "./hmia/a5.png"  )`;
                    break;
                case 7:
                    return `background-image: url( "./hmia/a6.png"  )`;
                    break;
                case 8:
                    return `background-image: url( "./hmia/a7.png"  )`;
                    break;
                case 9:
                    return `background-image: url( "./hmia/a8.png"  )`;
                    break;
        ...
        let arr3 = [[0.26, -0.85, 0.27, 0, -0.51, -0.05], [0.26, -0.85, 0.27, 0, -0.51, -0.05], [0.31, -1.20, 0.13, 0, -0.51, -0.05], [0.31, -0.94, -0.10, 0, -0.51, -0.05], [0.17, -0.96, -0.10, 0, -0.51, -0.05]]
        // 0121341
        function damo() {
        ...
        watch(topicNum, () => {
            ...
            stopTween(true)
            if (topicNum.value === 2) {
                startFree(getRobotPosition(), { x: -4.28, y: 22.36, z: -14.54 }, { x: -13.91, y: 7.74, z: 2.39 })
            }
        ...
        <div class="left_box" v-if="topicNum < 10">
            ...
            <div class="robot_opt" :style="topicOneImg">
                ...
                <div class="btn_page" v-if="topicNum === 3">
                    ...
                    <div class="conBtn" style="left: 335px;top: 91px;" @click="cangchu()"></div>
                    <div class="conBtn" style="left: 335px;top: 136px;" @click="stopTween(false)"></div>
                    <div class="conBtn" style="left: 334px;top: 181px;" @click="stopTween(true)"></div>
                </div>

                <div class="btn_page" v-if="topicNum === 4">
                    <!-- <div class="typeBtn" style="left: 319px;top: 287px;"></div> -->
                    <div class="conBtn" style="left: 328px;top: 75px;" @click="damo()"></div>
