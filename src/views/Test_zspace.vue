...
<template>
  <div class="main">
    ...
    <div
      class="right_tips"
      v-if="showControls && !topic.includes('工作站布局')"
    >
    ...
    <div class="list_box">
      <div class="tips_box">
        <div
          class="tips_item"
          v-for="tip in Tips[topic]"
          :key="tip"
          @click="runtonum(tip.type, tip.nums[0], tip.name)"
          :class="{
            tip1: tip.type === 'a',
            tip2: tip.type === 'b',
            tip3: tip.type === 'c',
