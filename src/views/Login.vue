	...
	<div class="back">
		...
		<div class="content_box">
			<div class="login_box" v-if="switchType">
				<div class="form_item">
					<el-row :gutter="20">
						<el-input v-model="useName" placeholder="请输入用户名" prefix-icon="el-icon-user" />
					</el-row>
				</div>
				<div class="form_item">
					<el-row :gutter="20">
						<el-input v-model="passWord" placeholder="请输入密码" prefix-icon="el-icon-suitcase" show-password />
					</el-row>
				</div>
